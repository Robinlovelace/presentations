...
+Areal aggregation [@lovelace2022] 
...
::: {.incremental}
-   Test performance and improve the '3-stage model' with more implementations/inputs (see Juan's commit to the [Zurich repo](https://github.com/Robinlovelace/zurich25)!).
-   Explore additional outputs of aggregate models, e.g. area used by modes, health and emissions impacts.
