...
-   Logical next step: try different implementations and inputs to benchmark performance and improve the '3-stage model' (credit: Juan Fonseca's commit to the Zurich repo!).
